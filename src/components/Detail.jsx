...
export default function Detail(props) {
    ...
    return (
        ...
        <div
            ...
            className="overflow-y-auto pt-11 overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal  justify-center items-center flex bg-no-repeat bg-cover "
            aria-modal="true"
            role="dialog"
        >
